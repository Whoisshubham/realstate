        ...
        <div class="container">
            ...
            <div class="user-area">
                ...
                <div class="language-bar">
                    <a href="#" class="active"><img src="{{asset('website')}}/assets/img/flags/gb.png" alt=""></a>
                    <a href="#"><img src="{{asset('website')}}/assets/img/flags/de.png" alt=""></a>
                    <a href="#"><img src="{{asset('website')}}/assets/img/flags/es.png" alt=""></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <header class="navbar" id="top" role="banner">
            <div class="navbar-header">
                ...
                <div class="navbar-brand nav" id="brand">
                    <a href="index-google-map-fullscreen.html"><img src="{{asset('website')}}/assets/img/logo.png"
                            alt="brand"></a>
                </div>
            </div>
            ...
            <div class="add-your-property">
                <a href="submit.html" class="btn btn-default"><i class="fa fa-plus"></i><span
                        class="text">Add Your Property</span></a>
            </div>
        </header><!-- /.navbar -->
    </div><!-- /.container -->
</div><!-- /.navigation -->
